...
if __name__ == '__main__':
    ...
    if args.cam:
        ...
        outputFile = args.video[:-4] + '_out.mp'

    elif args.image:
        cap = cv2.VideoCapture(args.image)
        #cap = cv2.detailEnhance(cap, kernel=10, range=0.15)
...
#####################
        # file='C:/Users/Ayman/Desktop/projeccc/E-ALPR/capture/'
...
###Generator
###Detect Plate
###Detect Object in plate using conr
###Get picture of these characters then pass it to the model trained model.h5
###then get out the result 
